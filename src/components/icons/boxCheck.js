const BoxCheck = ({ size, fill }) => (
  ...
  >
    ...
    <path d="m290.546 238.9-80.4 80.4-33.4-33.4c-4.7-4.7-12.3-4.7-17 0s-4.7 12.3 0 17l41.9 41.9c2.3 2.3 5.4 3.5 8.5 3.5s6.1-1.2 8.5-3.5l88.8-88.8c4.7-4.7 4.7-12.3 0-17-4.6-4.8-12.2-4.8-16.9-.1z" />
  </svg>
)
